...
class ForecastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create forecast" do
    assert_difference("Forecast.count") do
      post forecasts_url, params: { forecast: { data: @forecast.data, valid_until: @forecast.valid_until, zip: @forecast.zip } }
    end
  ...
  test "should update forecast" do
    patch forecast_url(@forecast), params: { forecast: { data: @forecast.data, valid_until: @forecast.valid_until, zip: @forecast.zip } }
